...
export default function RestaurantEcosystem() {
  ...
  return (
    <section id="features" className="snap-start snap-always min-h-screen lg:h-screen flex flex-col justify-center relative py-8 lg:py-16 overflow-hidden bg-[#FAFAFA]">
      ...
      <div className="relative max-w-7xl mx-auto px-6 w-full">
        ...
        <div className="lg:hidden flex flex-col items-center gap-6 mt-2 w-full">
          ...
          {/* Cards Grid */}
          <div className="grid grid-cols-2 sm:grid-cols-2 gap-3 w-full max-w-2xl px-2">
            <FeatureCard
              title={t("ecosystem.features.onlineOrdering")}
              Icon={ShoppingBag}
