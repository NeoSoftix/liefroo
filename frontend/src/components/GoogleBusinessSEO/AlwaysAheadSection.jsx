...
import { BarChart3, ShoppingBag, ShieldCheck, Wallet } from "lucide-react";
import { useTranslation } from "react-i18next";

const stats = [
  { key: "rankings", Icon: BarChart3 },
  { key: "orders", Icon: ShoppingBag },
  { key: "trust", Icon: ShieldCheck },
  { key: "savings", Icon: Wallet },
];

export default function AlwaysAheadSection() {
              ...
              >
                <div>
                  ...
                  <h4 className="font-bold text-gray-900 mt-2 lg:mt-3 text-xs sm:text-sm">
                    {t(`googleBusinessSEO.alwaysAhead.stats.${key}.title`)}
                  </h4>
                </div>
                <p className="text-[10px] sm:text-xs text-gray-500 mt-1">
                  {t(`googleBusinessSEO.alwaysAhead.stats.${key}.desc`)}
                </p>
              </motion.div>
            ))}
          </div>
