...
export default function Footer() {
  ...
  return (
    <footer className="snap-start snap-always min-h-screen lg:h-screen flex flex-col justify-center relative bg-[#fafafa] pt-10 lg:pt-16 pb-4 lg:pb-6 overflow-hidden w-full">
