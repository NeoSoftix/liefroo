...
//       <section className="flex flex-col justify-center relative bg-white py-10 lg:py-12 overflow-hidden w-full">
//         {/* Background glow */}
...
//       <section className="flex flex-col justify-center relative bg-[#FCFCFC] py-10 lg:py-12 overflow-hidden w-full">
//         {/* Background glow */}
